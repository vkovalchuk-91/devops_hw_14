...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "HW_14_Public-Subnet-${count.index + 1}"
  }
}
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "HW_14_Private-Subnet-${count.index + 1}"
  }
}
...
resource "aws_subnet" "database" {
  ...
  tags = {
    Name = "HW_14_Database-Subnet-${count.index + 1}"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "HW_14_Public-Route-Table-${count.index + 1}"
  }
}
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name = "HW_14_Private-Route-Table-${count.index + 1}"
  }
}
...
resource "aws_route_table" "database" {
  ...
  tags = {
    Name = "HW_14_Database-Route-Table-${count.index + 1}"
  }
}
